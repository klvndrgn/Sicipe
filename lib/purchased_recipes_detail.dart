...
class PurchasedRecipesDetailScreen extends StatefulWidget {
  ...
  @override
  State<PurchasedRecipesDetailScreen> createState() => _PurchasedRecipesDetailScreen();
}

class _PurchasedRecipesDetailScreen extends State<PurchasedRecipesDetailScreen> {
                ...
                children: [
                  Column(
                    ...
                    children: [
                      ...
                      Text("Berikan Penilaian Anda !",  style: GoogleFonts.jost(
              fontSize: 20,
              color: Colors.black,
              fontWeight: FontWeight.bold,
            ),),
                         Container(
                          ...
                          child: Row(
                            ...
                            mainAxisAlignment: MainAxisAlignment.center,
                        children: [
                   Icon( Icons.star_border_sharp, color: Colors.white,  size: 45,),
