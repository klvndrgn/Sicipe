...
class _FeedsSayaScreenState extends State<FeedsSayaScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      feedData.isEmpty ? Center(child: Text('Tidak ada Data')) : ListView.builder(
        ...
        itemBuilder:(context, index) {
          ...
          DateTime dateTime = DateTime.parse(tanggal).add(Duration(hours: 7));
                    ...
                    child: Column(
                      children: <Widget>[
                        ListTile(
                          ...
                          subtitle: Text(
                            formatDateTime(dateTime ?? new DateTime.now()),
                            style: GoogleFonts.jost(
                                  ...
                                  children: [
                                    IconButton(
                                        onPressed: () {
                                          setState(() {
                                            isFav = !isFav;
                                            print("Button Favorite : $isFav");
                                          });
                                        },
                                        icon: isFav ? Icon(Icons.favorite, color: Colors.redAccent) 
